...
export const universal: LanguageSpec = {
  ...
  tools: [
    ...
    },
    {
      ...
      ciArgv: "xargs -0 -r typos --force-exclude", ciFiles: true,
      priority: 2,
      stageFixed: true,
      install: {
    ...
    },
    {
      ...
      ciArgv: "xargs -0 -r editorconfig-checker", ciFiles: true,
      priority: 4,
      install: {
    ...
    },
    {
      ...
      ciArgv: "xargs -0 -r yamllint -c .yamllint.yaml", ciFiles: true,
      glob: '*.{yml,yaml}',
      priority: 5,
      install: {
    ...
    },
    {
      ...
      ciArgv: "xargs -0 -r markdownlint-cli2", ciFiles: true,
      glob: '*.{md,mdx}',
      priority: 5,
      install: {
    ...
    },
    {
      ...
      ciArgv: "xargs -0 -r shellcheck", ciFiles: true,
      glob: '*.{sh,bash}',
      priority: 5,
      install: {
    ...
    },
    {
      ...
      ciArgv: "xargs -0 -r shfmt -d -i 2 -ci", ciFiles: true,
      glob: '*.{sh,bash}',
      priority: 1,
      stageFixed: true,
      install: {
    ...
    },
    {
      ...
      ciArgv: "xargs -0 -r hadolint", ciFiles: true,
      glob: 'Dockerfile*',
      priority: 5,
      install: {
